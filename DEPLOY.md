...
| Эрх | Бүртгэл | Өдөр тутмын ажил |
|---|---|---|
| Үйлчлүүлэгч | Апп | Апп |
| Хувиараа артист | **Апп** | **Апп** |
| Салон | Вэб | Вэб панел (`/business/*`) |
| Супер админ | — | Вэб (`/admin/*`) |

Артистын вэб панел байхгүй: `/artist` нь "апп руу шилжсэн" гэсэн тайлбар
хуудас бөгөөд артист эрхтэй хүнийг `proxy.ts` тийш нь чиглүүлнэ.
