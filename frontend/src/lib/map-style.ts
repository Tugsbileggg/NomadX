 ...
 *
 * АНХААР: БУРУУ түлхүүр нь түлхүүргүйгээс ДОР. Хүчингүй түлхүүртэй үед ч
 * CARTO нь ус тэмдэгтэй зураг буцаадаг бөгөөд код нь ялгааг мэдэхгүй тул
 * OSM руу унахгүй. Тиймээс түлхүүрээ ажиллаж байгааг баталгаажуулаагүй
 * бол хувьсагчийг ХООСОН үлдээ — тэгвэл ус тэмдэггүй OSM зураг гарна.
 * Шалгах:
 *   curl -o t.png "https://a.basemaps.cartocdn.com/rastertiles/light_all/12/3264/1425@2x.png?key=ТҮЛХҮҮР"
 * гээд t.png дээр "API KEY REQUIRED" бичиг байгаа эсэхийг нүдээр хараарай.
