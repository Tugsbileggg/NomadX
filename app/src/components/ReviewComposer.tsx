  ...
  return (
    <>
      <Pressable onPress={start} style={styles.prompt}>
        ...
        <Ionicons name="chevron-forward" size={14} color={Brand.muted} />
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  promptText: { flex: 1, fontSize: 13, fontWeight: "600", color: Brand.ink },
  ...
  sheetTitle: { fontSize: 16, fontWeight: "700", color: Brand.ink },

  label: { fontSize: 12, fontWeight: "600", color: Brand.body, marginTop: 16 },
  ...
  error: { marginTop: 12, fontSize: 12, color: Brand.danger },
  ...
  deleteText: { fontSize: 12, fontWeight: "600", color: Brand.danger },
})
