...
/**
 * Артистын marker-ийн гадуурх цагирагийн өнгө.
 *
 * ⚠️ Аппын палитраас ЗОРИУДААР авахгүй. CARTO түлхүүргүй үед суурь зураг
 * нь үргэлж ЦАЙВАР OSM (`tileUrlFor`-ыг үзнэ үү) — гэтэл аппын горим
 * бараан байж болно. Тэгэхэд `primaryContainer` зэрэг токен нь бараан
 * улаан болж, цайвар зураг дээр цагираг биш ТОМ БАРААН БӨӨН болж
 * харагдана. Тиймээс marker-ийн цагаан хүрээтэй (`#fff`) ижил зарчмаар
 * тогтмол, тунгалаг өнгө сонгов — цайвар, бараан хоёр зураг дээр ч
 * зөөлөн гэрэлтэлт мэт уншигдана.
 */
export const MARKER_HALO = "rgba(138,72,83,0.34)"

/** Амьд артист — ижил тунгалаг байдалтай ногоон. */
export const MARKER_HALO_LIVE = "rgba(22,163,74,0.40)"
